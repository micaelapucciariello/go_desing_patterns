...
//Online store configures filters in order to search products
...
const (
	red Color = iota //creates incrementing constants
	green
	blue
)
...
func (f *Filter) filterBySizeAndColor(products []Product, size Size, color Color) []*Product {
	...
	return result
} //Violation of open close principle. Adding additional methods interferes with existing methods.

// filterBySize, filterBySizeAndColor

// Specification patter uses interfaces.
